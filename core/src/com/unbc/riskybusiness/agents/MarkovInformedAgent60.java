 ...
 */
public class MarkovInformedAgent60 extends Agent{

    private static int TYPICAL_ID = 0;
    private static double ACCEPTABLE_RISK = 0.6;
    private int myID;
    private List<Territory> potentialAttackers;
    
    public MarkovInformedAgent60(){
        myID = TYPICAL_ID++;
    ...
    public String toString(){
        return String.format("Markov-60 Agent %d", myID);
    }
}