 ...
 */
public class MarkovInformedAgent50 extends Agent{

    private static int TYPICAL_ID = 0;
    private static double ACCEPTABLE_RISK = 0.5;
    private int myID;
    private List<Territory> potentialAttackers;
    
    public MarkovInformedAgent50(){
        myID = TYPICAL_ID++;
    ...
    public String toString(){
        return String.format("Markov-50 Agent %d", myID);
    }
}